...
public class InactiveItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        parent = InactiveItemsActivity.this;
    ...
    public String CreateRequest()
    {
        ...
        TXML = "<ENVELOPE>" +
                ...
                "<EXPORTDATA>" +
                "<REQUESTDESC>" +
                "<REPORTNAME>Negative Stock</REPORTNAME>" +
                "</REQUESTDESC>" +
                "</EXPORTDATA>" +
                "</BODY>" +
                "</ENVELOPE>";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for(int i=0; i<ja_data.length(); i++) {
                    ...
                    String rate = jsonObject.getJSONArray("DSPSTKINFO").getJSONObject(i).
                            getJSONObject("DSPSTKCL").getString("DSPCLRATE");
                    if(!rate.equals("")) {
...
*/
                ...
                QuestionsAdapter questionsAdapter=new QuestionsAdapter(InactiveItemsActivity.this,arrarycashbalencelist);
