...
public class PurchaseDebitNoteActivity extends AppCompatActivity {
    ...
    public String CreateRequest()
    {
        ...
        TXML = "<ENVELOPE>"
                ...
                + "<REQUESTDESC>" +
                "<STATICVARIABLES>"
                + "<SVFROMDATE>20180331</SVFROMDATE>" +
...
*/
                ...
                QuestionsAdapter questionsAdapter=new QuestionsAdapter(PurchaseDebitNoteActivity.this,arrarycashbalencelist);
