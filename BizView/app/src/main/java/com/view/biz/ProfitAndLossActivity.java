...
public class ProfitAndLossActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        parent = ProfitAndLossActivity.this;
        img_calender= (ImageView) findViewById(R.id.img_calender);
...
*/
                ...
                QuestionsAdapter questionsAdapter=new QuestionsAdapter(ProfitAndLossActivity.this,arrarycashbalencelist);
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent in = new Intent(ProfitAndLossActivity.this, ProfitAndLossActivity.class);
