...
public class LedgerReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        parent = LedgerReportActivity.this;
...
*/
                ...
                QuestionsAdapter questionsAdapter=new QuestionsAdapter(LedgerReportActivity.this,arrarycashbalencelist);
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent in = new Intent(LedgerReportActivity.this, LedgerReportActivity.class);
