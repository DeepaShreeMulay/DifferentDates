...
public class PayableActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            new GetPayable().execute(CreateRequest());
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//    }
    ...
    public class GetPayable extends AsyncTask<String, Void, String> {
...
*/
                ...
                QuestionsAdapter questionsAdapter=new QuestionsAdapter(PayableActivity.this,arrarycashbalencelist);
